    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-500 text-gray-800 dark:text-gray-100">
            <div className="w-full h-5/6 bg-gray-200 dark:bg-gray-800 rounded-lg shadow-lg p-8">
                <div className="w-full p-8 mb-10 rounded md:p-12 bg-white dark:bg-gray-700 shadow-lg">
                ...
                <div className="w-full p-8 mt-10 md:p-12 bg-white dark:bg-gray-700 shadow-lg">
                    ...
                    <table className="w-full text-left border-collapse border-spacing-2">
                        <thead>
                            <tr className="bg-[#d0fcf4] dark:bg-[#558b88]">
                                <th className="p-3 border-b font-medium text-gray-700 dark:text-gray-200">Date</th>
                                <th className="p-3 border-b font-medium text-gray-700 dark:text-gray-200">Job Role</th>
                                <th className="p-3 border-b font-medium text-gray-700 dark:text-gray-200">Company</th>
                                <th className="p-3 border-b font-medium text-gray-700 dark:text-gray-200">Status</th>
                            </tr>
                        </thead>
                        <tbody>
